...
export const DELIVERY_COMMITMENTS_SEED: readonly DeliveryCommitmentSeed[] = [
  ...
  },
  {
    ...
    sourceLabel: "UK Parliament Bills",
    notes: "Search 'Planning and Infrastructure Bill' on bills.parliament.uk for the stage-by-stage record and the Act text. Royal Assent date is authoritative on the Legislation.gov.uk entry for the Act.",
    sortOrder: 50,
  },
  {
